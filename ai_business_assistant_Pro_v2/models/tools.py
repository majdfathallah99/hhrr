        ...
        return [
            {
                ...
                "function": {
                    "name": "count_records",
                    "description": "Count records in any model with an optional domain filter.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "model": _json_schema_string("Model technical name, e.g., 'res.partner' or 'sale.order'", True),
                            "domain": _json_schema_array({"type": "array"}, "Odoo domain as JSON array (e.g., [[\"customer_rank\", \">\", 0]])")
                        },
                        "required": ["model"]
                    }
                }
            },
            {
                ...
                "function": {
                    "name": "search_read",
                    "description": "search_read on any model.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "model": _json_schema_string("Model technical name", True),
                            "domain": _json_schema_array({"type": "array"}, "Odoo domain"),
                            "fields": _json_schema_array(_json_schema_string("Field name"), "List of field names"),
                            "limit": _json_schema_integer("Max number of records"),
                            "order": _json_schema_string("Order (e.g., 'name asc')"),
                        },
                        "required": ["model"]
                    }
                }
            },
            {
                ...
                "function": {
                    "name": "read_group",
                    "description": "Aggregation query on any model.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "model": _json_schema_string("Model technical name", True),
                            "domain": _json_schema_array({"type": "array"}, "Odoo domain"),
                            "fields": _json_schema_array(_json_schema_string("Field name"), "Aggregation fields with :sum,:count suffix etc. (e.g., ['amount_total:sum'])"),
                            "groupby": _json_schema_array(_json_schema_string("groupby field"), "Group by fields"),
                            "limit": _json_schema_integer("Limit groups"),
                            "orderby": _json_schema_string("Order groups"),
                        },
            ...
            },
            {
                ...
                "function": {
                    "name": "count_products",
                    "description": "Count stockable vs consumable products.",
            ...
            },
            {
                ...
                "function": {
                    ...
                    "description": "Create a quotation/sales order. If confirm=True it will be confirmed.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "partner_id": _json_schema_integer("Customer ID (optional)"),
                            "partner_name": _json_schema_string("Customer name (optional)"),
                            "date_order": _json_schema_string("Order date (YYYY-MM-DD)"),
                            "confirm": _json_schema_boolean("Confirm the order after creation"),
                            "lines": _json_schema_array({
                                "type": "object",
                                "properties": {
                                    "product_id": _json_schema_integer("Product ID (optional)"),
                                    "default_code": _json_schema_string("Internal reference/SKU (optional)"),
                                    "name": _json_schema_string("Product name to search (optional)"),
                                    "quantity": _json_schema_number("Quantity"),
                                    "price_unit": _json_schema_number("Unit price (optional)"),
                                },
                                "required": ["quantity"]
                            }, "Sales order lines"),
                        }
            ...
            },
            {
                ...
                "function": {
                    ...
                    "description": "Create a purchase order. If confirm=True it will be confirmed.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "vendor_id": _json_schema_integer("Vendor ID (optional)"),
                            "vendor_name": _json_schema_string("Vendor name (optional)"),
                            "date_order": _json_schema_string("Order date (YYYY-MM-DD)"),
                            "confirm": _json_schema_boolean("Confirm the PO after creation"),
                            "lines": _json_schema_array({
                                "type": "object",
                                "properties": {
                                    "product_id": _json_schema_integer("Product ID (optional)"),
                                    "default_code": _json_schema_string("SKU (optional)"),
                                    "name": _json_schema_string("Product name to search (optional)"),
                                    "quantity": _json_schema_number("Quantity"),
                                    "price_unit": _json_schema_number("Unit price (optional)"),
                                },
            ...
            },
            {
                ...
                "function": {
                    "name": "create_record",
                    "description": "Generic: create any record with given vals dict. Field names must be valid.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "model": _json_schema_string("Model technical name", True),
                            "vals": {"type": "object", "description": "Dictionary of field values"}
                        },
                        "required": ["model", "vals"]
                    }
                }
            },
            {
                ...
                "function": {
                    "name": "update_record",
                    "description": "Generic: write on an existing record id with vals.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "model": _json_schema_string("Model", True),
                            "id": _json_schema_integer("Record ID"),
                            "vals": {"type": "object", "description": "Dictionary of field values"}
                        },
            ...
            },
            {
                ...
                "function": {
                    "name": "delete_record",
                    "description": "Generic: unlink a record by id.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "model": _json_schema_string("Model", True),
