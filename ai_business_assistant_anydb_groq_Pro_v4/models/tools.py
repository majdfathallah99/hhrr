...
def _schema_str(desc, required=False):
...
def _schema_int(desc):
    return {"type": "integer", "description": desc}


def _schema_num(desc):
    return {"type": "number", "description": desc}


def _schema_bool(desc):
    return {"type": "boolean", "description": desc}


def _schema_array(item_schema, desc):
        ...
        return [
            {
                ...
                "function": {
                    ...
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "model": _schema_str("Model technical name, e.g., res.partner or sale.order", True),
                            "domain": _schema_array({"type": "array"}, "Odoo domain (JSON array)")
                        },
                        "required": ["model"]
                    }
                }
            },
            {
                ...
                "function": {
                    ...
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "model": _schema_str("Model technical name", True),
                            "domain": _schema_array({"type": "array"}, "Odoo domain"),
                            "fields": _schema_array(_schema_str("Field name"), "List of field names"),
                            "limit": _schema_int("Max number of records"),
                            "order": _schema_str("Order (e.g., name asc)"),
                        },
                        "required": ["model"]
                    }
                }
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            "model": _schema_str("Model technical name", True),
                            "domain": _schema_array({"type": "array"}, "Odoo domain"),
                            "fields": _schema_array(_schema_str("Field name"), "Aggregation fields with :sum or :count suffix"),
                            "groupby": _schema_array(_schema_str("groupby field"), "Group by fields"),
                            "limit": _schema_int("Limit groups"),
                            "orderby": _schema_str("Order groups"),
                        },
            ...
            },
            {
                ...
                "function": {
                    ...
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "partner_id": _schema_int("Customer ID (optional)"),
                            "partner_name": _schema_str("Customer name (optional)"),
                            "date_order": _schema_str("Order date (YYYY-MM-DD)"),
                            "confirm": _schema_bool("Confirm the order after creation"),
                            "lines": _schema_array({
                                "type": "object",
                                "properties": {
                                    "product_id": _schema_int("Product ID (optional)"),
                                    "default_code": _schema_str("Internal reference/SKU (optional)"),
                                    "name": _schema_str("Product name to search (optional)"),
                                    "quantity": _schema_num("Quantity"),
                                    "price_unit": _schema_num("Unit price (optional)"),
                                },
                                "required": ["quantity"]
                            }, "Sales order lines"),
                        }
            ...
            },
            {
                ...
                "function": {
                    ...
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "vendor_id": _schema_int("Vendor ID (optional)"),
                            "vendor_name": _schema_str("Vendor name (optional)"),
                            "date_order": _schema_str("Order date (YYYY-MM-DD)"),
                            "confirm": _schema_bool("Confirm the PO after creation"),
                            "lines": _schema_array({
                                "type": "object",
                                "properties": {
                                    "product_id": _schema_int("Product ID (optional)"),
                                    "default_code": _schema_str("SKU (optional)"),
                                    "name": _schema_str("Product name to search (optional)"),
                                    "quantity": _schema_num("Quantity"),
                                    "price_unit": _schema_num("Unit price (optional)"),
                                },
            ...
            },
            {
                ...
                "function": {
                    ...
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "model": _schema_str("Model", True),
                            "id": _schema_int("Record ID"),
                            "vals": {"type": "object", "description": "Dictionary of field values"}
                        },
