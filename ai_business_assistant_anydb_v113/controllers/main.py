...
class AIAssistantController(http.Controller):
    """Stable endpoints + minimal HTML chat (stateful)."""
    ...
    def _core_ai_logic(self, message: str):
        ...
        ToolModel = request.env.get(TOOLS_MODEL) and request.env[TOOLS_MODEL].sudo()
            tool_schemas = []
            if ToolModel:
                try:
        ...
        if tool_calls:
            ...
            # add model message + tool outputs to session history
