...
async function sendMsg(message){
  ...
  try{
    ...
    if(data && data.text){appendLog(data.text,'Assistant');speak(data.text);}else if(data && data.error){appendLog('Error: '+data.error,'Assistant');}else{appendLog('No response (check AI settings / network).','Assistant');}
