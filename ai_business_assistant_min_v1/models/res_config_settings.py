...
class ResConfigSettings(models.TransientModel):
    ...
    ai_provider = fields.Selection([
        ("openai", "OpenAI-compatible (incl. Groq/Ollama)"),
    ...
    ai_base_url = fields.Char(string="Base URL (override)", help="Optional: e.g., https://api.openai.com/v1 or https://api.groq.com/openai/v1 or http://<host>:11434/v1", config_parameter="ai_business_assistant.ai_base_url")
