...
class HrBonusRequest(models.Model):
    ...
    def create(self, vals_list):
        ...
        seq = self.env.ref("hr_department_bonus_safe_v10.seq_hr_bonus_request", raise_if_not_found=False)
        if seq:
            for rec in res:
    ...
    def action_approve(self):
        for rec in self:
            if rec.department_id and rec.department_id.bonus_remaining < rec.amount:
